...
import { Box, Chip, LinearProgress, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@mui/material'
  ...
  return (
    <Stack spacing={2.5}>
      ...
      <Box sx={{ bgcolor: '#fff', border: '1px solid #e3e9ef', borderRadius: 2.5, overflow: 'hidden' }}>
        ...
        <TableContainer><Table size="small" sx={{ minWidth: 760 }}><TableHead><TableRow>{['Locatie', 'Bezetting', 'Actief', 'Beschikbaar', 'Incidenten 90 dgn', 'Boven einddatum', 'Signaal'].map((h) => <TableCell key={h}>{h}</TableCell>)}</TableRow></TableHead>
