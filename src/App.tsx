...
const NetwerkcontactPage = lazy(() => import('./pages/NetwerkcontactPage'))
  ...
  return (
    <Routes>
      <Route path="/" element={<DashboardLayout />}>
        ...
        <Route path="jongeren/:clientCode/netwerkcontact/nieuw" element={<RoleGate roles={['Gedragswetenschapper', 'Zorgmanager']}><NetwerkcontactPage /></RoleGate>} />
        <Route path="uitstroom-registratie" element={<RoleGate roles={['Begeleider', 'Gedragswetenschapper', 'Zorgmanager']}><UitstroomRegistratiePage /></RoleGate>} />
